...
const sections = [
  ...
  { id: 'pflichtinformationen', label: '2. Allgemeine Hinweise und Pflichtinformationen' },
  { id: 'datenerfassung', label: '3. Datenerfassung auf unserer Website' },
  { id: 'google-analytics', label: '4. Google Analytics' },
  { id: 'google-plugins', label: '5. Andere Google Plugins und Tools' },
]
      ...
      <div className="container">
        <header>
          ...
          <p className="legal__lead">
            ...
            Website besuchen — und welche Rechte Sie dabei haben.
          </p>
        </header>
        ...
        <div className="legal__grid">
          ...
          <nav className="legal__toc" aria-label="Inhalt dieser Seite">
            <p className="legal__toc-title" id="datenschutz-toc">
              Inhalt
            </p>
            <ol aria-labelledby="datenschutz-toc">
              {sections.map((s) => (
                <li key={s.id}>
          ...
          <div className="legal__body">
            {/* ------------------------------------------ 1. Auf einen Blick */}
            <section className="legal__section" aria-labelledby="auf-einen-blick">
              <h2 id="auf-einen-blick">1. Datenschutz auf einen Blick</h2>
            ...
            <section
              ...
              aria-labelledby="pflichtinformationen"
            >
              <h2 id="pflichtinformationen">
            ...
            {/* ---------------------------------------- 3. Datenerfassung */}
            <section className="legal__section" aria-labelledby="datenerfassung">
              <h2 id="datenerfassung">3. Datenerfassung auf unserer Website</h2>
            ...
            <section
              className="legal__section"
              aria-labelledby="google-analytics"
            >
              ...
              <p>
                ...
                von Google sowie aus Besucherdaten von Drittanbietern. Diese
                Daten können keiner bestimmten Person zugeordnet werden. Sie
            ...
            {/* ---------------------------- 5. Andere Google Plugins/Tools */}
            <section className="legal__section" aria-labelledby="google-plugins">
              <h2 id="google-plugins">5. Andere Google Plugins und Tools</h2>

              <h3>YouTube</h3>
              <p>
                Unsere Website nutzt von Zeit zu Zeit Plugins der von Google
            ...
            <p className="legal__source">Quelle: e-recht24.de</p>
          </div>
        </div>
      </div>
    </div>
